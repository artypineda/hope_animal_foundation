...
if ( ! function_exists( 'hope_animal_foundation_setup' ) ) :
	...
	function hope_animal_foundation_setup() {
		 ...
		 * If you're building a theme based on hope_animal_foundation, use a find and replace
		 * to change 'hope_animal_foundation' to the name of your theme in all the template files.
		 */
 ...
 */
function hope_animal_foundation_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'hope_animal_foundation' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'hope_animal_foundation' ),
...
add_action( 'widgets_init', 'hope_animal_foundation_widgets_init' );
